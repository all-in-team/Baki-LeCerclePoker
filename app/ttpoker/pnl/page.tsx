...
/**
 * TTPOKER P&L on the generic LedgerShell (same swap as AKS/A5NUTS).
 ...
 */
export default async function TTPOKERPage({ searchParams }: { searchParams: Promise<{ filter?: string; player?: string }> }) {
  const params = await searchParams;
  const data = loadWalletLedger(params, {
    gameName: "TTPOKER",
    extrasKey: "ttpoker",
    title: "TTPOKER — P&L",
    basePath: "/ttpoker/pnl",
  });
      ...
      <LedgerShell
        ...
        headerAction={data.filterPlayerName ? (
          <span style={{ display: "inline-flex", alignItems: "center", gap: 8 }}>
            ...
            <a href="/ttpoker/pnl" style={{ fontSize: 11, color: "var(--text-muted)", textDecoration: "none" }}>✕ Retirer le filtre</a>
          </span>
        ) : undefined}
        actions={<SyncWalletsButton gameName="TTPOKER" />}
