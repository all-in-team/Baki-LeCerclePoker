...
/**
 * NUTSPK P&L on the generic LedgerShell (same swap as KKPOKER).
 ...
 * The shadow route (/nutspk/pnl/shadow) stays in place until cleanup.
 */
  ...
  return (
    <>
      <LedgerShell
        ...
        actions={<SyncWalletsButton gameName="NUTSPK" />}
