...
import { sheet, OPTS, CAS1, CAS2, type FixRow } from "./xpoker-fixture";
...
console.log("\n── 6. Vide ≠ zéro ──");
{
  ...
  eq("virgule décimale (locale FR) vs séparateur de milliers", [parseNum("-136,2"), parseNum("256,43"), parseNum("1,234"), parseNum("-31 267,4")], [-136.2, 256.43, 1234, null]);
