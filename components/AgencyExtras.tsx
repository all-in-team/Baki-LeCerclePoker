...
const CURRENCY_MAP: Record<string, string> = { akpoker: "USDT", wepoker: "CNY", kkpoker: "USDT", a5poker: "USDT", aks: "USDT" };

function fmt(n: number, currency: string) {
  return Math.abs(n).toLocaleString("fr-FR", { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + " " + currency;
}

export default function AgencyExtras({ gameKey }: { gameKey: "akpoker" | "wepoker" | "kkpoker" | "a5poker" | "aks" }) {
